...
async function seedEventData(arg1, arg2) {
  ...
  const sampleGuests = {
    "1": { id: "1", nombre: "Miguel Núñez y Familia", pases: 3, activo: true },
    "2": { id: "2", nombre: "Hendry Solís y Familia", pases: 3, activo: true },
    "3": { id: "3", nombre: "Guido Núñez y Silvia Lescano", pases: 2, activo: true },
    "4": { id: "4", nombre: "Karina Montoya", pases: 1, activo: true },
    "5": { id: "5", nombre: "Julio Carrillo y Esposa", pases: 2, activo: true },
    "6": { id: "6", nombre: "Alex Salazar y Esposa", pases: 2, activo: true },
    "7": { id: "7", nombre: "René Andino y Esposa", pases: 2, activo: true },
    "8": { id: "8", nombre: "Franklin Fiallos y Esposa", pases: 2, activo: true },
    "9": { id: "9", nombre: "Lourdes Fiallos", pases: 2, activo: true },
    "10": { id: "10", nombre: "Fernanda Lescano", pases: 2, activo: true },
    "11": { id: "11", nombre: "Luis Balladares y Esposa", pases: 2, activo: true },
    "12": { id: "12", nombre: "Danilo Jordan y Esposa", pases: 2, activo: true },
    "13": { id: "13", nombre: "Byron Ulloa y Esposa", pases: 2, activo: true },
    "14": { id: "14", nombre: "Mario Núñez y Esposa", pases: 2, activo: true },
    "15": { id: "15", nombre: "Nelson Núñez y Esposa", pases: 2, activo: true },
    "16": { id: "16", nombre: "Adriana Acosta y Familia", pases: 3, activo: true },
    "17": { id: "17", nombre: "Estalin López y Esposa", pases: 2, activo: true },
    "18": { id: "18", nombre: "Félix Rosero y Esposa", pases: 2, activo: true },
    "19": { id: "19", nombre: "Ricardo y Esposa", pases: 2, activo: true },
    "20": { id: "20", nombre: "Juan Ochoa y Esposa", pases: 4, activo: true },
    "21": { id: "21", nombre: "Carlos Mota y Esposa", pases: 2, activo: true },
    "22": { id: "22", nombre: "Rosa Rosero", pases: 1, activo: true },
    "23": { id: "23", nombre: "Jeremy Helsel", pases: 1, activo: true },
    "24": { id: "24", nombre: "Tony López", pases: 1, activo: true },
    "25": { id: "25", nombre: "Rodrigo Bayas y Familia", pases: 4, activo: true },
    "26": { id: "26", nombre: "Miguel Rosero", pases: 1, activo: true },
    "27": { id: "27", nombre: "Víctor Florence", pases: 2, activo: true },
    "28": { id: "28", nombre: "Manuela Gill", pases: 1, activo: true },
    "29": { id: "29", nombre: "Marcos Santana y Esposa", pases: 2, activo: true },
    "30": { id: "30", nombre: "Guido Reinoso y Esposa", pases: 2, activo: true },
    "31": { id: "31", nombre: "Nicole Berrios", pases: 1, activo: true },
    "32": { id: "32", nombre: "Leysha", pases: 1, activo: true },
    "33": { id: "33", nombre: "Gustavo Silva", pases: 1, activo: true },
    "34": { id: "34", nombre: "Ben Swann", pases: 1, activo: true },
    "35": { id: "35", nombre: "Juan and Anna", pases: 2, activo: true },
    "36": { id: "36", nombre: "Gino Lavarone", pases: 1, activo: true },
    "37": { id: "37", nombre: "Ángel Villagómez", pases: 2, activo: true },
    "38": { id: "38", nombre: "Gelena Solano", pases: 2, activo: true },
    "39": { id: "39", nombre: "Héctor Vides y Esposa", pases: 2, activo: true },
    "40": { id: "40", nombre: "Natalia D", pases: 2, activo: true },
    "41": { id: "41", nombre: "Touria y Familia", pases: 2, activo: true },
    "42": { id: "42", nombre: "Miggy y Esposo", pases: 2, activo: true },
    "43": { id: "43", nombre: "Whitney", pases: 1, activo: true },
    "44": { id: "44", nombre: "Benji", pases: 1, activo: true },
    "45": { id: "45", nombre: "Ms. Befumo", pases: 1, activo: true },
    "46": { id: "46", nombre: "Marlon Mora y Esposa", pases: 2, activo: true },
    "47": { id: "47", nombre: "Diego", pases: 1, activo: true },
    "48": { id: "48", nombre: "James Stauffer", pases: 2, activo: true },
    "49": { id: "49", nombre: "Ashley Pérez", pases: 1, activo: true },
    "50": { id: "50", nombre: "Angel Villamos", pases: 1, activo: true },
    "51": { id: "51", nombre: "Tommy and Riley", pases: 2, activo: true },
    "52": { id: "52", nombre: "Owen and Mecenna", pases: 2, activo: true },
    "53": { id: "53", nombre: "Married by Roxy", pases: 2, activo: true },
    "54": { id: "54", nombre: "Beatriz and Héctor", pases: 2, activo: true },
    "55": { id: "55", nombre: "Shane", pases: 1, activo: true },
    "56": { id: "56", nombre: "Drew", pases: 2, activo: true },
    "57": { id: "57", nombre: "Joe Matenti", pases: 2, activo: true },
    "58": { id: "58", nombre: "Jessica Alvarado", pases: 2, activo: true },
    "59": { id: "59", nombre: "Ana", pases: 1, activo: true },
    "60": { id: "60", nombre: "Kevin", pases: 1, activo: true },
    "61": { id: "61", nombre: "Ray", pases: 1, activo: true },
    "62": { id: "62", nombre: "Martín", pases: 1, activo: true },
    "63": { id: "63", nombre: "Sergio Meza y Esposa", pases: 2, activo: true },
    "64": { id: "64", nombre: "Harrison and Kayla", pases: 2, activo: true },
    "65": { id: "65", nombre: "Bailee", pases: 1, activo: true }
  };
